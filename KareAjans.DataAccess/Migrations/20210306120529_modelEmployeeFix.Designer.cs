...
namespace KareAjans.DataAccess.Migrations
{
    ...
    [Migration("20210306120529_modelEmployeeFix")]
    partial class modelEmployeeFix
    {
            ...
            modelBuilder.Entity("KareAjans.Entity.ExpenseType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ExpenseTypeID = 1,
                            Amount = 10m,
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 887, DateTimeKind.Local).AddTicks(8080),
                            Title = "Yemek"
                        },
                        new
                        {
                            ExpenseTypeID = 2,
                            Amount = 40m,
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 888, DateTimeKind.Local).AddTicks(3676),
                            Title = "Konaklama"
                        },
                        new
                        {
                            ExpenseTypeID = 3,
                            Amount = 0m,
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 888, DateTimeKind.Local).AddTicks(3694),
                            Title = "Maas"
                        });
                });
            ...
            modelBuilder.Entity("KareAjans.Entity.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PermissionID = 1,
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 892, DateTimeKind.Local).AddTicks(9405),
                            UserType = 1
                        },
                        new
                        {
                            PermissionID = 2,
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 892, DateTimeKind.Local).AddTicks(9434),
                            UserType = 2
                        },
                        new
                        {
                            PermissionID = 3,
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 892, DateTimeKind.Local).AddTicks(9436),
                            UserType = 3
                        },
                        new
                        {
                            PermissionID = 4,
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 892, DateTimeKind.Local).AddTicks(9437),
                            UserType = 4
                        });
                });
            ...
            modelBuilder.Entity("KareAjans.Entity.ProfessionalDegree", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 894, DateTimeKind.Local).AddTicks(1692),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 894, DateTimeKind.Local).AddTicks(1727),
                            DailyPercentage = (byte)0,
                            DailyWage = 100m,
                            Title = "Kategori2"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 894, DateTimeKind.Local).AddTicks(2000),
            ...
            modelBuilder.Entity("KareAjans.Entity.SiteContent", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SiteContentID = 1,
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 903, DateTimeKind.Local).AddTicks(9198),
                            SiteContentType = 0,
                            Text = "seed about"
                        },
                        new
                        {
                            SiteContentID = 2,
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 903, DateTimeKind.Local).AddTicks(9227),
                            SiteContentType = 1,
            ...
            modelBuilder.Entity("KareAjans.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            CreatedDate = new DateTime(2021, 3, 6, 15, 5, 28, 894, DateTimeKind.Local).AddTicks(9730),
